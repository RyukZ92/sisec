    ...
    */
    ...
    function showResult($strDescription = ''){
        if ($this->fltStopTime > 0.0) {
            //return $strDescription.round($this->fltStopTime - $this->fltStartTime, $this->intOutputPrecision).' segs.';
            return round($this->fltStopTime - $this->fltStartTime, $this->intOutputPrecision);
        } else {
            //return $strDescription.round($this->getMicroTime() - $this->getMidTime(), $this->intOutputPrecision).' segs.';
            return round($this->getMicroTime() - $this->getMidTime(), $this->intOutputPrecision);
        }
    }
